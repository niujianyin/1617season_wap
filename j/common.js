...
;(function(win, doc) {
  ...
  if($("#gameType").length>0){
    globGameType = $("#gameType").val() || '';
  }
  if(!globGameType){
    globGameType = util.getQueryString('gameType');
  }
  ...
  if(globGameType.indexOf("z5_") > -1){
    ...
    $(".js-login").attr("href", 'http://passport.sina.cn/signin/signin?entry=wapsso&vt=4&r=http%3A%2F%2Feuro.sina.cn%2Flottery%2F&amp;revalid=1');
