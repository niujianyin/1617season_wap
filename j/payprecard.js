/*
* http://n.sinaimg.cn/sports/lottseason1617/wap/j/payprecard.js
* module payprecard.js
* author：niujy
...
(function(){
  ...
  util.yppay = {
    ...
    payStep4: function(amount, chargeWay,cardType) {
      ...
      var dataUrl="";
      if(cardType=="vipCard"){
        dataUrl='http://odds.sports.sina.com.cn/odds/giftpay/vipCardPay?thirdId='+euro_wbId+'&amount='+amount+'&hdCode=16001&chargeWay='+chargeWay+'&type=vipCard&format=json&client=wap';
      }else if(cardType=="chgCard"){
        dataUrl='http://odds.sports.sina.com.cn/odds/giftpay/chgCardPay?thirdId='+euro_wbId+'&amount='+amount+'&hdCode=16001&chargeWay='+chargeWay+'&type=chgCard&format=json&client=wap';
      }
      $.ajax({
        url:dataUrl,
        dataType: 'jsonp',
